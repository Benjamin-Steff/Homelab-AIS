...
Une infrastructure Hyper-V repose sur :
...
Hyper-V permet de créer des **virtual switches** pour connecter les machines virtuelles.
...
- **Live Migration**
- **Failover Clustering**
- **Backup des machines virtuelles**
